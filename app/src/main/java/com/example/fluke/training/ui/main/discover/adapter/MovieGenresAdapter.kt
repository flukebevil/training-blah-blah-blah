...
import com.example.fluke.training.ui.main.discover.holder.MovieGenresHolder
...
class MovieGenresAdapter(private var arr: List<MovieType>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): RecyclerView.ViewHolder
            = MovieGenresHolder(LayoutInflater.from(parent?.context).inflate(viewType, parent, false))
